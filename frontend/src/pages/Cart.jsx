      ...
      <div >
        {
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className='border-t py-4 text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4' >
                ...
                <input onChange={(e)=>e.target.value===''||e.target.value==='0'?null:updateQuantity(item._id,item.size,Number(e.target.value)) } type='number' value={item.quantity} className='bordre max-w-10 sm:max-w-20 px-1 sm:px-2 py-1' />
