...
const Product = () => {
  ...
  return productData ?(
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500opacity-100'>
      {/* product section */}
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='mt-20 '>
              <div className='flex'>
                <b className='bordrer px-5 py-3 text-sm'>
                  Description
                </b>
                <p className='bordrer px-5 py-3 text-sm'>Reviews(122)</p>
              </div>
              <div className='flex flex-col gap-4 border-gray-800 px-6 py-6 text-sm text-gray-500'>
